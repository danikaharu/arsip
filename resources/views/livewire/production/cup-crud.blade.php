@section('title')Data Produksi Cup 240 ml @endsection
<x-slot name="header">
    <h2 class="text-center">Data Produksi Cup 240 ml</h2>
</x-slot>
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @if ($isModalOpen)
                @include('livewire.production.cup.create')
            @endif
